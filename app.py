...
<body>
    ...
    <div class="container">
        ...
        <div class="info-card">
            ...
            <div class="info-item">
                <span class="info-label">Number of Leases</span>
                <span class="info-value">{{ num_leases }}</span>
            </div>
        </div>
...
def generate():
    ...
    for para in doc.paragraphs:
        ...
        if "{{num_leases}}" in para.text:
            para.text = para.text.replace("{{num_leases}}", str(num_leases))
    ...
    for table in doc.tables:
        for row in table.rows:
            for cell in row.cells:
                ...
                if "{{num_leases}}" in cell.text:
                    cell.text = cell.text.replace("{{num_leases}}", str(num_leases))
